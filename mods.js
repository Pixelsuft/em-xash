zipMods = [
	['halva_en.zip', 'Half-Life EN (214M)', 214283501, 0],
	['blue_shift_rus.zip', 'Blue Shift EN (221M)', 221191140, 0],
	['opposing_force_en.zip', 'Opposing Force EN (221M)', 221191140, 0],
	['halva_rus.zip', 'Half-Life RUS (304M)', 303881453, 12, 26214400],
	['blue_shift_rus.zip', 'Blue Shift RUS (223M)', 223479923, 0],
	['opposing_force_rus.zip', 'Opposing Force RUS (224M)', 223479923, 0]
];
